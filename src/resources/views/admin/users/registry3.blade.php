                                            ...
                                            <form class="form-horizontal" action="{{route('admin.user.registry')}}" method="post" id="form-user" accept-charset="utf-8">
                                                ...
                                                <div class="form-group validateGroup row"><label class="col-sm-3 col-form-label" for="name_kana">名前カナ<span class="badge badge-danger ml-2">必須</span></label>
                                                    <div class="col-sm-8">
                                                        ...
                                                        </div><input class="form-control validate name_kana" type="text" name="name_kana" id="name_kana" data-validate="empty katakana" value="{{$formData['name_kana']}}">
                                                    </div>
                                                </div>
                                                <div class="form-group validateGroup row"><label class="col-sm-3 col-form-label" for="email">メールアドレス<span class="badge badge-success ml-2">任意</span></label>
                                                    <div class="col-sm-8">
                                                        <div class="error-tip">
                                                            <div class="error-tip-inner"></div>
                                                        </div><input class="form-control validate email" type="email" name="email" id="email" data-validate="empty email" value="{{$formData['email']}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group validateGroup row"><label class="col-sm-3 col-form-label">組織・権限<span class="badge badge-danger ml-1">必須</span></label>
                                                    <div class="col-sm-3"><select class="form-control validate organization_id validate" id="organization_id" name="organization_id" data-validate="empty">
                                                ...
                                                <div class="form-group validateGroup row mb-2"><label class="col-form-label col-sm-3">所属事務局名</label>
                                                    <div class="col-sm-6">
                                                        <p class="form-control-static">{{$baseName}}</p>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
