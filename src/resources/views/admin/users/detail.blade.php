                        ...
                        <div class="col-sm-12">
                            <div class="card card-main">
                                ...
                                <div class="pt30 card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form class="form-horizontal" action="{{$submitForm}}" method="post" id="form-user" accept-charset="utf-8"><input type="hidden" name="user_id" value="{{$member['id']}}">
                                                @csrf
                                                ...
                                                <div class="form-group validateGroup row"><label class="col-sm-3 col-form-label">所属事務局名<span class="badge badge-success ml-1">任意</span></label>
                                                    <div class="col-sm-3">
                                                        <div class="base-select-wrap">
                                                            @if($isSelectBase)
                                                                <select class="form-control validate base_id select2" id="base_id" name="base_id">
                                                                    <option value="">選択してください</option>
                                                                    @foreach($bases as $key=>$base)
                                                                    <option value="{{$base['id']}}" @if($base['id'] == $member['baseId']) selected="selected" @endif>{{$base['name']}}</option>
                                                                    @endforeach
                                                                </select>
                                                             @endif
                                                        </div>
